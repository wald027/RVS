...
df_regras_emails = pd.read_excel(r"IntelligentProcessAutomationNLP\ModelNLP\RegrasEmails.xlsx",sheet_name='RegrasEmailsPreTratamento',keep_default_na=False)
df_regras_emails_ignorar = pd.read_excel(r"IntelligentProcessAutomationNLP\ModelNLP\RegrasEmails.xlsx",sheet_name='RegrasEmailDiscard',keep_default_na=False)
